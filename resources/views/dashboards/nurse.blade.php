        ...
        <div class="d-flex flex-column align-items-center text-center py-4 py-md-5">
            ...
            <div class="row g-3 g-sm-4 justify-content-center w-100" style="max-width:980px">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <a class="aw-tile text-decoration-none d-block" href="{{ route('nurse.meds.schedule') }}">
                        <span class="bi bi-capsule-pill tile-icon"></span>
                        <div class="en">TODAY'S MEDICATIONS</div>
                        <div class="small opacity-75 mt-1">Give and log meds due now</div>
                    </a>
                </div>
                <!-- 2) Patients -->
                <div class="col-12 col-md-6 col-lg-4">
                    <a class="aw-tile text-decoration-none d-block" href="{{ route('nurse.inmates.index') }}">
                        <span class="bi bi-person-badge tile-icon"></span>
                        <div class="en">INMATES</div>
                        <div class="small opacity-75 mt-1">View inmates & records</div>
                    </a>
                </div>
                <!-- 3) Lab Tests -->
                <div class="col-12 col-md-6 col-lg-4">
                    <a class="aw-tile text-decoration-none d-block" href="{{ route('nurse.lab-tests.index') }}">
                        <span class="bi bi-clipboard2-check tile-icon"></span>
                        <div class="en">LAB TESTS</div>
                        <div class="small opacity-75 mt-1">Orders & uploads</div>
                    </a>
                </div>
            </div>
        </div>
