<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.donation-requests.index') }}" class="btn btn-outline-secondary btn-sm">Back to List</a>
        </div>
    </x-slot>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                             ...
                             <form action="{{ route('admin.donation-requests.update', $donationRequest) }}" method="POST" class="d-flex align-items-center gap-2 mt-1">
                                @csrf @method('PUT')
