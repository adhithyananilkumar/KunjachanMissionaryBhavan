<div class="row g-3">
  <div class="col-lg-6">
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between align-items-center">Medications <a class="btn btn-sm btn-outline-secondary" href="{{ route('admin.inmates.edit',$inmate) }}#medications">Edit</a></div>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">Therapy & Counseling <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.inmates.edit',$inmate) }}#therapy">Log</a></div>
      <div class="card-body small">
