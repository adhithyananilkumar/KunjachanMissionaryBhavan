<form action="{{ route('admin.inmates.update',$inmate) }}" method="POST" class="card shadow-sm" data-ajax>
  @csrf
  @method('PUT')
  ...
  <div class="card-footer d-flex gap-2">
    ...
    <a class="btn btn-outline-secondary" href="{{ route('admin.inmates.edit',$inmate) }}">Open full editor</a>
  </div>
</form>
