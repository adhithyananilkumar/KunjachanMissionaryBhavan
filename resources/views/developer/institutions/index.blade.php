<x-app-layout>
	...
	<div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
		<h1 class="h4 mb-0">Institutions</h1>
		<a href="{{ route('developer.institutions.create') }}" class="btn btn-primary"><span class="bi bi-plus-lg me-1"></span>Add</a>
	</div>
	<form method="GET" action="{{ route('developer.institutions.index') }}" class="card card-body mb-3 shadow-sm small">
		<div class="row g-2 align-items-end">
			...
			<div class="col-md-2 d-flex gap-2">
				...
				<a href="{{ route('developer.institutions.index') }}" class="btn btn-light btn-sm">Reset</a>
			</div>
		</div>
	</form>
	<div class="list-group shadow-sm mb-4">
		@forelse($institutions as $institution)
			<div class="list-group-item d-flex gap-3 align-items-start position-relative py-3">
				<a href="{{ route('developer.institutions.edit',$institution) }}" class="position-absolute top-0 start-0 w-100 h-100" style="z-index:1;" aria-label="Open institution"></a>
				...
				<div class="dropdown ms-auto position-relative" style="z-index:2;">
					...
					<div class="dropdown-menu dropdown-menu-end shadow-sm">
						<a href="{{ route('developer.institutions.edit',$institution) }}" class="dropdown-item"><span class="bi bi-pencil-square me-2"></span>Edit</a>
...
document.addEventListener('DOMContentLoaded', function(){
	...
	modal.addEventListener('show.bs.modal', function (event) {
		...
		form.action = '{{ url('developer/institutions') }}/' + instId;
