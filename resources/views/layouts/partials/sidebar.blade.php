        ...
        <ul class="nav nav-pills flex-column py-2">
            @auth
                ...
                @elseif($role==='system_admin')
                    ...
                    <li class="nav-item"><a class="nav-link aw-link {{ request()->routeIs('system_admin.blogs.*') ? 'active' : '' }}" href="{{ route('admin.blogs.index') }}"><span class="bi bi-journal-text me-2"></span>Blog</a></li>
