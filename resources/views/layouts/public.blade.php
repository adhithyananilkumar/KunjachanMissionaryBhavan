...
<body>
    ...
    <div class="header-accent" aria-hidden="true">
        <svg viewBox="0 0 1440 100" preserveAspectRatio="none">
            <defs>
                <linearGradient id="navWave" x1="0" y1="0" x2="1" y2="1">
                    <stop offset="0%" stop-color="var(--kb-accent)" stop-opacity=".15" />
                    <stop offset="100%" stop-color="var(--kb-primary)" stop-opacity=".08" />
                </linearGradient>
            </defs>
            <path
                d="M0,64L48,74.7C96,85,192,107,288,101.3C384,96,480,64,576,42.7C672,21,768,11,864,26.7C960,43,1056,85,1152,101.3C1248,117,1344,107,1392,101.3L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"
                fill="url(#navWave)" />
        </svg>
    </div>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-3">
                ...
                @auth
                    <li class="nav-item ms-lg-2"><a href="{{ route('dashboard') }}" class="btn btn-outline-secondary rounded-pill px-3">Dashboard</a></li>
                @else
                    <li class="nav-item ms-lg-2"><a href="{{ route('login') }}" class="btn btn-outline-secondary rounded-pill px-3">Login</a></li>
                @endauth
            </ul>
        </div>
    </div>
...
<div class="header-accent" aria-hidden="true">
    <svg viewBox="0 0 1440 100" preserveAspectRatio="none">
        ...
        <path d="M0,64L48,74.7C96,85,192,107,288,101.3C384,96,480,64,576,42.7C672,21,768,11,864,26.7C960,43,1056,85,1152,101.3C1248,117,1344,107,1392,101.3L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z" fill="url(#navWave)"/>
    </svg>
    </div>
...
<footer class="site-footer py-4">
    <div class="container footer-grid mb-2">
        <div>
            <a class="d-inline-flex align-items-center gap-2 text-decoration-none" href="{{ route('home') }}">
                <img src="{{ asset('assets/kunjachanMissionaryLogo.png') }}" alt="{{ $appName }} Logo" class="logo-img" style="height:40px">
                <span class="brand-title" style="text-transform:none">{{ $appName }}</span>
            </a>
            <div class="small muted mt-2">Compassion • Dignity • Community</div>
        </div>
        ...
        <div>
            ...
            <ul class="list-plain small muted">
                <li class="mb-1">Kunjachan Missionary Bhavan<br>Idiyanal P.O, Ramapuram<br>Kottayam, Kerala</li>
                <li class="mb-1"><a href="mailto:kunjachanmissionary@gmail.com">kunjachanmissionary@gmail.com</a></li>
                <li class="mb-1"><a href="tel:+918281960435">+91 82819 60435</a></li>
                <li><a target="_blank" rel="noopener" href="https://maps.app.goo.gl/NP69bHdpmoBK2MY37">Google Maps</a></li>
            </ul>
        </div>
        <div>
            <h6 class="text-uppercase small text-muted mb-2">Follow</h6>
