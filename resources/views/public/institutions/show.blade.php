    ...
    <div class="container">
        <div class="surface p-0 overflow-hidden mb-3">
            <div class="position-relative" style="height:240px;">
                <img src="{{ $institution['hero'] }}" alt="{{ $institution['name'] }}" class="w-100 h-100" style="object-fit:cover;">
                <div class="position-absolute bottom-0 start-0 p-3" style="background:linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,.45) 80%); width:100%;">
                    ...
                    <div class="text-white-50 small">{{ $institution['location'] }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-lg-7">
                <div class="surface h-100">
                    ...
                    <p class="muted">This is a placeholder overview for {{ $institution['name'] }}. Share the story, mission focus, and resident care approach unique to this center.</p>
                    <ul class="list-check">
