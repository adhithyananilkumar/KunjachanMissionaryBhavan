  ...
  <script>
    (function(){
      ...
      document.addEventListener('click', function(e){
        ...
        const postOne = (mid) => fetch('{{ route('nurse.meds.log') }}', { method:'POST', headers:{'X-CSRF-TOKEN':'{{ csrf_token() }}','Accept':'text/html' }, body: new URLSearchParams({ medication_id: mid, status: 'taken' }) });
