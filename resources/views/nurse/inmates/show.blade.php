<x-app-layout>
    ...
    <style>
        .nurse-patient-header img{ width:56px; height:56px; object-fit:cover; }
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex align-items-center gap-3 flex-wrap nurse-patient-header">
                ...
                <a href="{{ route('nurse.inmates.index') }}" class="btn btn-link btn-sm text-decoration-none"><span class="bi bi-arrow-left me-1"></span> Back to Patients</a>
            </div>
            ...
            <div class="tab-content border rounded bg-white p-2 p-md-4 mt-2">
                ...
                <div class="tab-pane fade" id="tab-reportings" role="tabpanel">
                    <form method="POST" action="{{ route('nurse.inmates.examinations.store',$inmate) }}" class="border rounded p-2 p-md-3 bg-light-subtle">
                        @csrf
                        <div class="row g-2">
