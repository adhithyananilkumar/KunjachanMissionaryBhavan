<x-app-layout>
	...
	<div class="card mb-4"><div class="card-body">
		<dl class="row mb-0">
			<dt class="col-sm-3">Patient</dt><dd class="col-sm-9">{{ $labTest->inmate->full_name }}</dd>
	...
	<div class="card"><div class="card-body">
		...
		@else
		<form method="POST" action="{{ route('staff.lab-tests.partial-update',$labTest) }}" enctype="multipart/form-data">
			@csrf
			@method('PATCH')
			<div class="row g-3">
				<div class="col-md-12">
			...
			<div class="d-flex gap-2">
				...
				<a href="{{ route('staff.lab-tests.index') }}" class="btn btn-outline-secondary">Back</a>
			</div>
		</form>
		@endif
		</div></div>
	@push('scripts')
	<script>
	// Auto-mark notification as read when visiting from notification list
