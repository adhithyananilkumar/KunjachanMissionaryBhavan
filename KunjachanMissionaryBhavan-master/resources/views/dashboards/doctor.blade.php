        ...
        <div class="d-flex flex-column align-items-center text-center py-4 py-md-5">
            ...
            <div class="row g-3 g-sm-4 justify-content-center w-100" style="max-width:980px">
                <div class="col-12 col-md-6 col-lg-4">
                    <a class="aw-tile text-decoration-none d-block" href="{{ route('doctor.inmates.index') }}">
                        <span class="bi bi-person-badge tile-icon"></span>
                        <div class="en">INMATES</div>
                        <div class="small opacity-75 mt-1">View assigned inmates</div>
                    </a>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <a class="aw-tile text-decoration-none d-block" href="{{ route('doctor.appointments.index') }}">
                        <span class="bi bi-calendar-event tile-icon"></span>
                        <div class="en">APPOINTMENTS</div>
                        <div class="small opacity-75 mt-1">Manage your schedule</div>
                    </a>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <a class="aw-tile text-decoration-none d-block" href="{{ route('doctor.lab-tests.index') }}">
                        <span class="bi bi-clipboard2-check tile-icon"></span>
                        <div class="en">LAB TESTS</div>
                        <div class="small opacity-75 mt-1">Orders & results</div>
                    </a>
                </div>
            </div>
        </div>
