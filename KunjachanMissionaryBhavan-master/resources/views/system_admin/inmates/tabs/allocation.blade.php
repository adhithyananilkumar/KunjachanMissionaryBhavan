  ...
  <div class="card-body">
    ...
    <div class="row g-3">
      ...
      <div class="col-12 col-md-4">
        <form id="allocAssignForm" method="POST" action="{{ route('system_admin.inmates.assign-location', $inmate) }}" data-inst="{{ (int)$inmate->institution_id }}">
          @csrf
...
{{-- Note: All JavaScript for this tab is initialized from the host view (inmates/show.blade.php) via initAllocationTab() after AJAX load. --}}
