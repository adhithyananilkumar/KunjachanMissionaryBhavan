        ...
        <ul class="nav nav-pills flex-column py-2">
            @auth
                ...
                @elseif($role==='admin')
                    ...
                    <li class="nav-item"><a class="nav-link aw-link {{ request()->routeIs('admin.donation-requests.*') ? 'active' : '' }}" href="{{ route('admin.donation-requests.index') }}"><span class="bi bi-heart me-2"></span>Donations</a></li>
                    <li class="nav-item"><a class="nav-link aw-link {{ request()->routeIs('admin.contact-submissions.*') ? 'active' : '' }}" href="{{ route('admin.contact-submissions.index') }}"><span class="bi bi-envelope me-2"></span>Messages</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link aw-link {{ request()->routeIs('admin.gallery.*') ? 'active' : '' }}" href="{{ route('admin.gallery.index') }}"><span class="bi bi-images me-2"></span>Gallery</a></li>
                ...
                @elseif($role==='system_admin')
                    ...
                    <li class="nav-item"><a class="nav-link aw-link {{ request()->routeIs('system_admin.donation-requests.*') ? 'active' : '' }}" href="{{ route('system_admin.donation-requests.index') }}"><span class="bi bi-heart me-2"></span>Donations</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link aw-link {{ request()->routeIs('system_admin.contact-submissions.*') ? 'active' : '' }}" href="{{ route('system_admin.contact-submissions.index') }}"><span class="bi bi-envelope me-2"></span>Messages</a></li>
